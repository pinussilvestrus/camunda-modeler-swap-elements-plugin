...
/* harmony import */ var _features_swap_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./features/swap-elements */ "./client/features/swap-elements/index.js");
...
class SwapElementsPlugin extends camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  constructor(props) {
    ...
    subscribe('bpmn.modeler.configure', event => {
      ...
      middlewares.push(addModule(_features_swap_elements__WEBPACK_IMPORTED_MODULE_1__["default"]));
    });
